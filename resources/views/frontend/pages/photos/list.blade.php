				...
				<div class="col-xs-12">
					...
					@if ( !$datas->count() )
						...
						<ul class="ace-thumbnails clearfix">
								...
								<li>
									<a href="{{ url(session('site_upload').'/products/'.$data->image) }}" data-rel="colorbox">
										<img width="150" height="150" alt="150x150" src="{{ url(session('site_upload').'/products/'.$data->image) }}" />
									</a>
									...
									<div class="tools">
										...
										<a href="{{ route('photos.delete', $data->id) }}">
