	...
	<div class="main-content-inner">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/satislar') }}">
							{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="fatura" id="form-field-1" placeholder="Fatura No" class="col-xs-10 col-sm-3" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="vade" id="form-field-1" placeholder="Vade" class="col-xs-10 col-sm-3" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="doviz" id="form-field-1" placeholder="Döviz Br Satış" class="col-xs-10 col-sm-3" />
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Döiz Türü</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="dovizkur" id="form-field-1" placeholder="Döviz Kuru" class="col-xs-10 col-sm-3" />
							</div>
						</div>
