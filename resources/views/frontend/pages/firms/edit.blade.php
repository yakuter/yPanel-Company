	...
	<div class="main-content-inner">
		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Esnaf Düzenle</li>
			</ul><!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{{ Form::open(['url' => '/admin/firms/'.$data->id, 'method' => 'put', 'id'=>'validation-form', 'class'=>'form-horizontal', 'files'=>true ]) }}
					...
					@endif
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="contact" id="contact"  class="col-xs-10 col-sm-5" value="{{ $data->contact }}" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="phone" id="phone" class="col-xs-10 col-sm-5" value="{{ $data->phone }}" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<img src="{{ url(session('site_upload').'/firms/'.$data->image) }}" width="120"/>
