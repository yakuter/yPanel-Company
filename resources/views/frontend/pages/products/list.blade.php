							...
							<tr>
								...
								<td>
									<div class="hidden-sm hidden-xs btn-group">
										...
										<button class="btn btn-xs btn-info" onClick="location.href='{{ url('/admin/products/'.$data->id.'/edit') }}'">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</button>

										<button class="btn btn-xs btn-danger" onClick="location.href='{{ route('products.delete', $data->id) }}'">
