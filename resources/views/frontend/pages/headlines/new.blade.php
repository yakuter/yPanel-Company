...
jQuery(function($){	
	...
	$('#validation-form').validate({
		...
		messages: {
			...
			image: {
				required: "Lütfen bir resim dosyası seçiniz!",
	...
	<div class="main-content-inner">
		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Yeni Manşet</li>
			</ul><!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{{ Form::open(['url' => '/admin/headlines', 'method' => 'POST', 'id'=>'validation-form', 'class'=>'form-horizontal', 'files'=>true ]) }}
					...
					@endif
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
								<input type="text" name="name" id="name"  class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
								<input type="text" name="link" id="link" class="col-xs-10 col-sm-5" placeholder="http://www.yakuter.com" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="clearfix">
									<textarea name="info" id="info" rows="4" class="form-control"></textarea>
								</div>
							</div>
						</div>
