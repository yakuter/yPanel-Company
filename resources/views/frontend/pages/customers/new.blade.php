	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Yeni Müşteri</li>
			</ul><!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{{ Form::open(['url' => '/admin/customers/', 'method' => 'POST', 'class'=>'form-horizontal', 'id'=>'validation-form' ]) }}
					{{ csrf_field() }}
					...
					@endif
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="name" id="name" placeholder="Müşteri" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="clearfix">
									<textarea name="info" rows="3" class="form-control" id="info" placeholder="Adres"></textarea>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="country" id="country" placeholder="Ülke" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="city" id="city" placeholder="Şehir" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="contact" id="contact" placeholder="İletişim Personeli" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="phone" id="phone" placeholder="0232 232 2323" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="email" id="email" placeholder="isim@isim.com" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="clearfix">
									<textarea name="notes" id="notes" rows="3" class="form-control" placeholder="Notlar"></textarea>
								</div>
							</div>
						</div>
