...
@section('pagehead')
<link rel="stylesheet" href="{{ URL::asset('panel/css/bootstrap-datepicker3.min.css') }}" />
@endsection
...
<script src="{{ URL::asset('panel/js/bootstrap-datepicker.min.js') }}"></script>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{{ Form::open(['url' => '/admin/news/', 'method' => 'POST', 'class'=>'form-horizontal', 'id'=>'validation-form' ]) }}
					...
					{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<input type="text" name="name" placeholder="Haber Başlığı" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						</div>
