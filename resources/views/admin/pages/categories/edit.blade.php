		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{{ Form::open(['url' => '/admin/categories/'.$data->id, 'method' => 'put', 'id'=>'validation-form', 'class'=>'form-horizontal', 'files'=>true ]) }}
					...
					@endif
									...
									@if ( !$categories->count() )
								   	...
								   	@else
								    	...
								    	@foreach ( $categories as $category )
								    		@if ( $category->parent_id==0 && $category->id != $data->id )
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<img src="{{ url(config('settings.site_upload').'/cats/'.$data->image) }}" width="120"/>
